...
public class PowerV2 extends StatusEffect implements Comparable<PowerV2> {
    ...
    public PowerV2(StatusEffectCategory category, int duration, boolean ambient, boolean showParticles, boolean showIcon) {
        super(category, duration);
        this.duration = duration;
        this.ambient = ambient;
        this.showParticles = showParticles;
    ...
    public void upgrade(PowerV2 that, StatusEffectCategory effect, int integer) {
        ...
        if (that.amplifier > this.amplifier) {
            if (that.lastsShorterThan(this)) {
                PowerV2 power = this.hiddenEffect;
                this.hiddenEffect = new PowerV2(effect, integer);
                this.hiddenEffect.hiddenEffect = power;
            }
            ...
            if (that.amplifier == this.amplifier) {
                ...
                this.hiddenEffect.upgrade(that, effect, integer);
            }
        }
    ...
    public static class FactorCalculationData {
        public static final Codec<PowerV2.FactorCalculationData> CODEC = RecordCodecBuilder.create(
                instance -> instance.group(
                        ...
                        .apply(instance, PowerV2.FactorCalculationData::new)
        );
        ...
        public void update(PowerV2 effect) {
